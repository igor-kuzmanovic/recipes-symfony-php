...
INSERT INTO recipe (title, description, date, category_id, image) VALUES ('Pepperoni Pizza', 'A pepperoni pizza with additional hot-sauce', '2019-03-03', (SELECT id FROM category WHERE name = 'Breakfast'), 'http://localhost:8000/images/hot_pizza.jpeg');
INSERT INTO recipe (title, description, date, category_id, image) VALUES ('Vegetarian Pizza', 'A vegetarian pizza rich with vitamins.', '2019-02-02', (SELECT id FROM category WHERE name = 'Dinner'), 'http://localhost:8000/images/vegan_pizza.jpeg');
INSERT INTO recipe (title, description, date, category_id, image) VALUES ('Pineapple Pizza', 'A fruity pizza rich with a tropical twist.', '2019-01-01', (SELECT id FROM category WHERE name = 'Lunch'), 'http://localhost:8000/images/pineapple_pizza.jpeg');
