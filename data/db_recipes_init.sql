...
INSERT INTO recipe (title, description, date, category_id, image_url) VALUES ('Pineapple Pizza', 'A fruity pizza rich with a tropical twist.', CURRENT_TIMESTAMP, (SELECT id FROM category WHERE name = 'Lunch'), 'http://localhost:8000/images/pineapple_pizza.jpeg');
